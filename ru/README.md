...
* какие выводы совпали, разошлись или не подтвердились;
...
Это оригинал на русском; английская версия — перевод, в [корне репозитория](../README.md). Файлы разбиты по этапам конвейера — от исходной задачи до финального сравнения.
...
Эти файлы отвечают на один и тот же исходный prompt. Читайте их как независимые попытки найти архитектурные риски в одном и том же коде.
...
* [`4-adjudication/gpt55.md`](4-adjudication/gpt55.md) — финальное сравнение двух сравнений, выполненное GPT 5.5.
* [`4-adjudication/opus48.md`](4-adjudication/opus48.md) — финальное сравнение двух сравнений, выполненное Opus 4.8.
...
4. Посмотрите одно первичное ревью.
5. Посмотрите prompt процедуры сравнения.
6. Сравните два результата процедуры сравнения.
...
2. Другие модели не делают ревью заново, а сравнивают результаты: извлекают claims, проверяют их по коду и проставляют статус.
...
Для нового проекта достаточно заменить исходный architecture review prompt и первичные ответы моделей. Процедура сравнения почти не зависит от pgjdbc.
