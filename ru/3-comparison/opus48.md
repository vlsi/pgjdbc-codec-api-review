...
Решения 4 (text-read leaf) и 7 (`pg_range`) — следующая итерация, но интерфейс text-leaf лучше набросать уже сейчас, чтобы `ArrayLeafCodec` его выдержал.
